...
export default function DataFloraTable() {
  ...
  if (!confirm("Yakin ingin menghapus data ini?")) return;
    try {
      const res = await fetch(`/api/flora/${id}`, { method: "DELETE" });
      if (res.ok) {
          ...
          <Table>
            ...
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                ...
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Tipe Vegetasi</TableCell>
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Jumlah Kerapatan</TableCell>
                ...
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Manfaat Ekologi</TableCell>
                <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Manfaat Ekonomi</TableCell>
              ...
              {loading ? (
                ...
                data.map((row, idx) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">{row.tipe_vegetasi}</TableCell>
                    <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">{row.jumlah_kerapatan}</TableCell>
                    ...
                    <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">{row.manfaat_ekologi}</TableCell>
                    <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">{row.manfaat_ekonomi}</TableCell>
                    ...
                    <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                      <Link href={`/data-flora/${row.id}/edit`}>
                        <button
